async function postCoinbaseKeys(apiKey, apiSecret) {
    try {
        const response = await fetch('https://api.coinmerge.co/api/coinbase/keys', {
            method: 'POST',
            credentials: 'include',
            headers: {
...
async function postGeminiKeys(apiKey, apiSecret) {
    ...
    try {
        const response = await fetch('https://api.coinmerge.co/api/gemini/keys', {
            method: 'POST',
            credentials: 'include',
            headers: {
                'Content-Type': 'application/json',
...
async function uploadLedgerCSV(fileInput) {
    ...
    try {
        const response = await fetch('https://api.coinmerge.co/api/ledger/upload-csv', {
            method: 'POST',
            credentials: 'include',
            body: formData,
        });
...
async function fetchCoinbaseData() {
    const response = await fetch('https://api.coinmerge.co/api/coinbase/json', {
        method: 'GET',
        credentials: 'include'
    });
    if (!response.ok) {
...
async function fetchGeminiData() {
    const response = await fetch('https://api.coinmerge.co/api/gemini/json', {
        method: 'GET',
        credentials: 'include'
    });
    if (!response.ok) {
...
async function fetchLedgerData() {
    const response = await fetch('https://api.coinmerge.co/api/ledger/json', {
        method: 'GET',
        credentials: 'include'
    });
    if (!response.ok) {
...
async function fetchMasterData() {
    const response = await fetch('https://api.coinmerge.co/api/master/json', {
        method: 'GET',
        credentials: 'include'
    });
    if (!response.ok) {
...
async function fetchMasterTotalBalance() {
    const response = await fetch('https://api.coinmerge.co/api/master/total-balance', {
        method: 'GET',
        credentials: 'include'
    });
    if (!response.ok) {
...
async function fetchCoinbaseTotalBalance() {
    const response = await fetch('https://api.coinmerge.co/api/coinbase/total-balance', {
        method: 'GET',
        credentials: 'include'
    });
    if (!response.ok) {
...
async function fetchGeminiTotalBalance() {
    const response = await fetch('https://api.coinmerge.co/api/gemini/total-balance', {
        method: 'GET',
        credentials: 'include'
    });
    if (!response.ok) {
...
async function fetchLedgerTotalBalance() {
    const response = await fetch('https://api.coinmerge.co/api/ledger/total-balance', {
        method: 'GET',
        credentials: 'include'
    });
    if (!response.ok) {
...
async function downloadMasterXLSX() {
    try {
        const response = await fetch('https://api.coinmerge.co/api/master/download-xlsx', {
            method: 'GET',
            credentials: 'include'
        });
